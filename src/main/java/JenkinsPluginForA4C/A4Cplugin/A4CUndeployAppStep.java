...
public class A4CUndeployAppStep extends Builder implements SimpleBuildStep {
    ...
    private final Boolean waitForUnDeployEnd;

    private AlienDriver alienDriver;

    // Fields in config.jelly must match the parameter names in the "DataBoundConstructor"
    @DataBoundConstructor
    public A4CUndeployAppStep(String login, String password, String port, String a4cDomain, String topoName, String environmentName,Boolean waitForUnDeployEnd) {

        this.waitForUnDeployEnd=waitForUnDeployEnd;
        ...
        try{
            ...
            if(deploymentId!=null) {
                ...
                if(!status.equals("UNDEPLOYED")) {
                    ...
                    if(waitForUnDeployEnd){
                        alienDriver.waitForApplicationStatus(deploymentId,"UNDEPLOYED");
                    }
                }
            }else{
                listener.getLogger().println("Application is already undeployed");
            }
        }catch (Exception e){
